...
class AudioSpeaker {
  public:
     ...
     */
    explicit AudioSpeaker(boost::shared_ptr<Receiver> receiver);
  ...
  private:
    const boost::shared_ptr<Receiver>
...
class AudioRecorder {
  public:
     ...
     */
    explicit AudioRecorder(boost::shared_ptr<Sender> sender);
